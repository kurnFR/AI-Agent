...
try:
    ...
    raise AssertionError("Expected ValueError for self dependency")
except ValueError as exc:
...
print("Unknown dependency: PASSED")
print("Self dependency: PASSED")
print("Circular dependency: PASSED")
